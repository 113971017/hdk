...
/*
 * Disable interrupts (by setting Pr=0), while keeping the CPU mode unchanged
 */
static INLINE void mlx16_di_keep_mode(void) {
 ...
 */
static INLINE void mlx16_di_enter_system_mode(void) {
 ...
 */
static INLINE void mlx16_enter_system_mode_keep_prio(void) {
...
/** @defgroup atomic Code Sections, <atomic.h>

    Creates Atomic and/or System sections.
...
/*
    Note that the macros in this header file require the ISO/IEC 9899:1999
...
/** @ingroup atomic
    ...
    @warning Code section shall be finished with ::EXIT_SECTION
...
int main(void)
{
    ...
    accessing variable `ctr`, so it is guaranteed to be consistently
    tested.
*/
#if defined(__DOXYGEN__)
...
/** @ingroup atomic
    ...
    @brief End of of code section

    Marks the end of code section started by the ::ENTER_SECTION
